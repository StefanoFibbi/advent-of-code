...
fun main() {
    ...
    println("Day 04, part 1 (example): $exampleP1")
    println("Day 04, part 1 (solution): $solutionP1")
    println("Day 04, part 2 (example): $exampleP2")
    println("Day 04, part 2 (solution): $solutionP2")
}
